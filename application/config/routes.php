...
$route['product/category/(:num)/(:any)'] = 'frontend/product/category/$1/$2';
$route['product/detail/(:num)/(:any)'] = 'frontend/product/detail/$1/$2';
$route['service'] = 'frontend/service/index';
$route['gallery'] = 'frontend/gallery/index';
$route['contact'] = 'frontend/contact/index';
$route['contact/form/action'] = 'frontend/contact/formAction';
$route['contact/thanks'] = 'frontend/contact/thanks';
