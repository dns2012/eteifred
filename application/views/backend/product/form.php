            ...
            <div class="col-10">
                ...
                <div class="card mb-3">
                    <div class="card-header d-flex justify-content-between border-bottom-0">
                        ...
                        <div class="btn-group">
                            <a href="<?=site_url('admin/product')?>" class="btn btn-xs btn-danger">
                                CANCEL
                            </a>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="<?=site_url('admin/product/form/action/'.$id)?>" method="post" id="form" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-5">
                                    ...
                                    <?php ;} else { ?>
                                        <div class="form-group">
                                            <input type="file" name="image" class="dropify" data-height="225" data-default-file="<?=$cdnProduct.$product->image?>" data-allowed-file-extensions="jpg jpeg png" data-max-file-size="1M"/>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <textarea class="tinymce" name="description" id=""><?=(!empty($product))?$product->description:''?></textarea>
                                    </div>
                                </div>
                            </div>
                        </form>
