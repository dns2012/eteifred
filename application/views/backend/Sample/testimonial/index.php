            ...
            <div class="col-12">
                <div class="card mb-3">
                    <div class="card-header d-flex justify-content-between border-bottom-0">
                        ...
                        <a href="<?=site_url('admin/testimonial/form/0')?>" class="btn btn-xs btn-primary">
                ...
                <div class="card">
                    <table class="table table-order table-hover">
                        ...
                        <tbody>
                        <?php foreach($testimonial as $index => $testimonial): ?>
                            <tr>
                                <td class="text-left"><?=$index+1?></td>
                                <td class="text-left"><?=$testimonial->name?></td>
                                <td class="text-left"><?=$testimonial->profession?></td>
                                <td class="text-left"><?=$testimonial->testimonial?></td>
                                <td class="text-right">
                                    <a href="<?=site_url('admin/testimonial/form/'.$testimonial->id)?>" class="btn btn-default btn-xs border-radius-6">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="<?=site_url('admin/testimonial/delete/'.$testimonial->id)?>" class="btn btn-primary">
                                                DELETE
                                            </a>
                                        </div>
                                    </div>
